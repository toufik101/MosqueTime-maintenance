...
const IONAMasjid = () => {
  ...
  const [mosqueName, setMosqueName] = useState("IONAMasjid");
    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-white to-green-100">
      ...
      >
        <div className="absolute inset-0  flex flex-col justify-center items-center text-center px-6">
          ...
          <a href="https://maps.app.goo.gl/y16jcGtw8wEN4Q2F9" className="mt-2 text-lg md:text-2xl text-gray-200">
            {Mosquelocation}
          </a>
        </div>
