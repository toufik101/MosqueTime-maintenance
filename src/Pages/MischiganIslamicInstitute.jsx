...
const MischiganIslamicInstitute = () => {
  const [data, setData] = useState([]);
  const [monthName, setMonthName] = useState("");
  const [mosqueName, setMosqueName] = useState("MischiganIslamicInstitute");
  ...
  useEffect(() => {
    ...
    const loadData = async () => {
      try {
        ...
        setLocation(loc);
        setMosqueName("MischiganIslamicInstitute");
    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-white to-green-100">
      ...
      >
        <div className="absolute inset-0  flex flex-col justify-center items-center text-center px-6">
          ...
          <a
            href="https://share.google/WW3Gfk1O4WgxzOKxd"
...
export default MischiganIslamicInstitute;
